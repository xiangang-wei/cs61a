...
def reverse_other(t):
    ...
    """
    "*** YOUR CODE HERE ***"
    # Personaly I am confused about the question's description
    # The solution is from internet and it collect all the labels of each node's branches in a sequence, reverse them and assign 
    # to the branches at its origin order
